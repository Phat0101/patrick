  ...
  return (
    <footer className="bg-blue-50 dark:bg-gray-900 py-8">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className=" text-xs text-gray-500 dark:text-gray-300/50 mt-2">Built with Next.js, Tailwind CSS, Framer Motion, Resend | Powered by Gemini 2.0 Flash | Inspired by ByteGrad and Aga Kadela.</p>
